...
val appModule = module {
    ...
    single { AuditLog() }
    single { ApiOperations(androidContext(), get<com.snatik.storage.core.fs.FileSystem>(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get()) }
    ...
    viewModel { (p: String) -> com.snatik.storage.app.feature.media.DevelopViewModel(get(), p) }
