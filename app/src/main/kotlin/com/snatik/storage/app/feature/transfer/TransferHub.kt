...
class TransferHub(context: Context, fs: FileSystem, private val scope: CoroutineScope) {
    ...
    val server = TransferServer(fs, inboxDir, deviceName, BuildConfig.VERSION_NAME)
