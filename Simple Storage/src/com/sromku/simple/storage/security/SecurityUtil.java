...
public class SecurityUtil
{
	 ...
	 *            have the same content after descryption then the same IV must be used. <i>About this
	 *            parameter from wiki: https://en.wikipedia.org/wiki/Block_cipher_modes_of_operation
	 *            #Initialization_vector_.28IV.29</i> <b>Important: The length must be 16 long</b>
	 * @return
	 */
