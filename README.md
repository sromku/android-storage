...
- Viewers per file type: syntax-highlighted code and text, a JSON and an XML tree, hex with an ASCII column, images with pinch zoom and an EXIF sheet, a video and audio player, a deep APK inspector, and a zip archive browser.
